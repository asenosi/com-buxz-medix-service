...
const NotFound = () => {
  ...
  return (
    <div className="p-4 md:p-8 pb-24">
      <div className="relative max-w-4xl mx-auto border-4 border-dashed border-primary/30 rounded-3xl p-6 md:p-12 bg-background/50 backdrop-blur-sm overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="mb-4 md:mb-6 relative">
            <h1 className="text-6xl sm:text-8xl md:text-9xl font-bold text-primary/90 animate-bounce-smooth select-none">
              404
            </h1>
          ...
          {/* Error path display */}
          <div className="p-3 md:p-4 bg-muted/50 rounded-lg border-2 border-dashed border-border/50 backdrop-blur-sm animate-fade-in" style={{ animationDelay: '0.8s' }}>
