      ...
      <CardContent className="p-4 sm:p-6 overflow-hidden">
        <div className="grid gap-4 lg:gap-6 lg:grid-cols-2">
          ...
          <div className="space-y-4 overflow-hidden">
            <div className="rounded-lg border p-3 space-y-3 overflow-hidden">
            ...
            <div className="rounded-lg border p-3 space-y-3 overflow-hidden">
              ...
              <div className="space-y-3 rounded-lg border p-3 overflow-hidden">
            ...
            <AccordionUI.Accordion type="single" collapsible defaultValue="types">
              <AccordionUI.AccordionItem value="types" className="border rounded-lg overflow-hidden">
                ...
                <AccordionUI.AccordionContent className="px-3 pb-3 space-y-3 overflow-hidden">
                    ...
                    <div key={category} className="space-y-2 overflow-hidden">
                      ...
                      <div className="grid gap-2">
                        {items.map((t) => {
                          ...
                          return (
                            <div key={t.key} className="flex items-center justify-between rounded-md border p-2.5 gap-3">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 items-center overflow-hidden">
